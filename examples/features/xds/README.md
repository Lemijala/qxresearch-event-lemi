...
hello world
example](https://github.com/Lemijala/qxresearch-event-lemi/tree/main/examples/helloworld). The
...
A27](https://github.com/Lemijala/qxresearch-event-lemi/blob/main/A27-xds-global-load-balancing.md#xdsclient-and-bootstrap-file)
